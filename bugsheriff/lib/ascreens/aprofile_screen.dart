...
import 'package:bugsheriff/aleft_sidebar.dart'; // Sol menüyü import edin
...
class _ProfileScreenPageState extends State<aProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: aLeftSidebar(), // Keep the sidebar
      body: _isLoading
